        ...
        <div class="row">
          <div class="col">
            <div class="page-title">
                ...
                <span>Penambahan Saldo ATK</span>
            </div>
          </div>
        </div>
        <form action="{{url('/kirim-tambah-saldo-atk/'.$dataAtk->kodeBarang)}}" class="form" method="post">
            @csrf
        <div class="row">
                <div class="col-10">
                        <div class="group">
            ...
            <div class="col-4">
                <div class="group">
                    <select name="satuanBarang" id="satuanBarang" readonly>
                        <option readonly selected value="{{$dataAtk->satuanBarang}}">{{$dataAtk->satuanBarang}}</option>
                    </select>
