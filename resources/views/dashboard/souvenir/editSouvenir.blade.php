        ...
        <div class="row">
          <div class="col">
            <div class="page-title">
                ...
                <span>Edit Souvenir</span>
            </div>
          </div>
        </div>
        <form action="{{url('/kirim-edit-souvenir/'.$dataSouvenir->kodeBarang)}}" class="form" method="post">
            @csrf
        <div class="row">
                <div class="col-10">
                        <div class="group">
            ...
            <div class="col-4">
                <div class="group">
                    <select name="satuanBarang" id="satuanBarang">
                        <option selected value="{{$dataSouvenir->satuanBarang}}">{{$dataSouvenir->satuanBarang}}</option>
