...
<head>
    ...
    <title>Transaksi ATK Masuk</title>
...
<body>
    ...
    <div class="content-container">
        <div class="row">
            ...
            <div class="col-3">
                <a href="/transaksi-atk-keluar" class="btn btn-success">
        ...
        <div class="row">
            ...
            <a href="/transaksi-atk-masuk-tambah-saldo" class="col-3 btn btn-light" style="border-bottom-right-radius: 0px;border-bottom-left-radius: 0px;">
                <i class="fa-solid fa-right-from-bracket"></i>
